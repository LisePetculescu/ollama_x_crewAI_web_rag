...
This project is partly based on Steffen Segovia Helbo's week 8 & 9 lectures on *Ollama RAG - Custom Ollama RAG Path* and *Website chat Local RAG* in LLM for Developers (Spring 2026). Description of this in [here](week8_rag_setup_guide.md).

The documents in **docs/** are generated by ChatGPT and ClaudeAI
